  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400  h-[12vh] sticky top-0 z-[1] bg-white">
      ...
      <ul className="hidden md:flex items-start gap-5 font-medium">
        ...
        <NavLink to="/doctors">
          <li className="py-1 text-lg">ALL DOCTORS</li>
          <hr className="border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to="/about">
        ...
        <NavLink to="/contact">
          <li className="py-1 text-lg">CONTACT</li>
          <hr className="border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden" />
        </NavLink>
      </ul>
          ...
          <div className="flex items-center gap-2 cursor-pointer group relative">
            ...
            <div className="absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block">
              <div className="min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4">
                ...
                {/* <NavLink to='/my-profile' className="hover:text-black cursor-pointer">
                  My Profile
                  <hr className="border-none outline-none h-0.5 bg-primary w-2/5 ml-0 m-auto hidden" />
                </NavLink> */}
                <p
